...
/** @cg/* packages that may only be imported by Main-tier code. */
export const MAIN_ONLY_PACKAGES: readonly string[] = [
  '@cg/persistence',
  '@cg/caspar-client',
  '@cg/audit',
  '@cg/telemetry',
...
export const RENDERER_ONLY_PACKAGES: readonly string[] = ['@cg/shared-ui'];
