...
| `D-` | `D-159` | the Inspector explains in prose what it could express in state — withheld controls, state rows, fields, the `i`, one legible default; 61 reachable blocks swept, 24 moved      | [designer.md](designer.md)           | closed in code; Linux `gate:e2e` discharged for `c305f9ad` (run 33921378832, `E2E (Playwright)` RAN, 621 s, `success`) |
...
- `B-277` — an AMCP refusal reached the operator as its number (`FIELD-FIXES-01` A).
