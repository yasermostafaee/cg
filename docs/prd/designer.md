...
> composition's in-point.** Linux `e2e` DISCHARGED for `f9a35507` —
> <https://github.com/yasermostafaee/cg/actions/runs/31644333051> (`success`, and the `e2e` job
> RAN); this supersedes the runs for `0d2d0c3b`, `f492939d` and `6e620f70`, each of which verified a
