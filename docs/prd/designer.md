...
- **SEQUENCING — dependency:** implement this AFTER the open Designer bug **B-037** (pen tool — owner decision 2026-07-07: KEEP + fix; in progress on `fix/B-037-pen-multi-shape`) is done — templates should exercise healthy features (**B-042** is done/archived, see `bugs-designer.md`). **BLOCKED** until B-037 lands. (The other prerequisites — **D-060** auto-size, **B-035** fit-on-open, **B-036** icon align — are done as of 2026-07-07.)
