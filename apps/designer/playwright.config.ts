 ...
 *
 * ⚠ **LOWERED FROM 8.5 ON 2026-09-24** for the same reason as the last time: the Runtime suite
 * outgrew its 7.5 (`C-016`'s spec on a slow runner) and the SUM is fixed.
 *
