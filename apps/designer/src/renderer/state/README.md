...
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`view`](slices/view.ts)                    | `tool`, `rulerVisible`, `snappingEnabled`, `aspectLockOff` (B-218 — the per-plate / per-arrangement aspect-lock OFF set), `snapGuides`, `guides` | `setTool`, `toggleRuler`, `toggleSnapping`, `setAspectLock(key, enabled)` + the `isAspectLocked(state, key)` predicate, `setSnapGuides`, `addGuide`, `setGuidePos`, `removeGuide`                                                                                                                                                                                                                                                                                                                                                                                   |
| [`selection`](slices/selection.ts)          | `selection`, `editingTextId`, `editingPathId` (D-124 path point-edit mode)                                                                       | `setSelection`, `toggleInSelection`, `setEditingText`, `setEditingPath`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [`document`](slices/document.ts)            | `scene`, `projectPath`, `view`, `notice`                                                                                                         | `setScene`, `setView`, `showNotice`, `dismissNotice`, `updateScene`, `setSceneDurationFrames`, `setSceneActiveOut`, `setLifecycle`, `setContentStart`, `setPlayout`                                                                                                                                                                                                                                                                                                                                                                                                 |
